...
export default function SocialChallenge() {
  ...
  async function handleSubmit(isCorrect) {
    if (isLastLevel && isCorrect) {
      ...
      setResult({ correct: isCorrect, healthChange: isCorrect ? levelData.healthReward : -levelData.healthPenalty, xpGained: isCorrect ? levelData.xpReward : 0, realWorldStat: pickStat() });
    }
  }
